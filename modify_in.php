...
<body id="bodyb">
	<?php	
		...
		$sql="SELECT indirizzo FROM utente WHERE username = '".$_SESSION['username']."'";
		...
		if (isset($_POST['update'])){				
					$query = "UPDATE utente SET indirizzo= '".$_POST['indirizzo']."' WHERE username='".$_SESSION['username']."'";					
		...
		<form method="post" action="" class="form" style="margin-top:60px;">
			...
			<input type="text" value="<?php echo $user['indirizzo'] ?>" name="indirizzop" class="form-control" readonly>
			<label> Nuovo Indirizzo </label>
			<input type="text" value="" name="indirizzo" class="form-control"><br>
