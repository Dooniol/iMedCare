...
<body id="bodyb">
	<?php	
		...
		if (isset($_POST['update'])){				
					$query = "UPDATE utente SET relazione= '".$_POST['relazione']."' WHERE username='".$_SESSION['username']."'";					
		...
		<form method="post" action="" class="form" style="margin-top:60px;">
			<label> Codice Relazione </label>
			<input type="text" value="" name="relazione" class="form-control"><br>
